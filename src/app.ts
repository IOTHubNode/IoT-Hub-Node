...
const ACoptions = {
  key: fs.readFileSync(path.resolve(__dirname, './config/assets/server.key')), // SSL私钥文件路径
  cert: fs.readFileSync(path.resolve(__dirname, './config/assets/server.crt')), // SSL证书文件路径
};
